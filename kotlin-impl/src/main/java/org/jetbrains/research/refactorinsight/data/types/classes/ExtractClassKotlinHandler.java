    ...
    public RefactoringInfo specify(Refactoring refactoring,
        ...
        if (ref.getAttributeOfExtractedClassTypeInOriginalClass() != null) {
            ...
            ref.getExtractedOperations().forEach(operation -> info.addMarking(
                    CodeRange.createCodeRangeFromKotlin(operation.codeRange()),
                    CodeRange.createCodeRangeFromKotlin(ref.getExtractedClass().codeRange()),
                    CodeRange.createCodeRangeFromKotlin(ref.getAttributeOfExtractedClassTypeInOriginalClass().codeRange()),
            ...
            info.addMarking(CodeRange.createCodeRangeFromKotlin(ref.getOriginalClass().codeRange()),
                    CodeRange.createCodeRangeFromKotlin(ref.getExtractedClass().codeRange()),
                    CodeRange.createCodeRangeFromKotlin(ref.getAttributeOfExtractedClassTypeInOriginalClass().codeRange()),
            ...
            ref.getExtractedOperations().forEach(operation -> info.addMarking(
                    CodeRange.createCodeRangeFromKotlin(operation.codeRange()),
                    CodeRange.createCodeRangeFromKotlin(ref.getExtractedClass().codeRange()), true));
