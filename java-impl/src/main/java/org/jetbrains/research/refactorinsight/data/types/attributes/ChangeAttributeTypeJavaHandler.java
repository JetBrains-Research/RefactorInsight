...
public class ChangeAttributeTypeJavaHandler extends Handler {
    ...
    public RefactoringInfo specify(Refactoring refactoring, RefactoringInfo info) {
        ...
        return info.setGroup(Group.ATTRIBUTE)
                ...
                .addMarking(CodeRange.createCodeRangeFromJava(ref.getOriginalAttribute().getType().codeRange()),
                        CodeRange.createCodeRangeFromJava(ref.getChangedTypeAttribute().getType().codeRange()),
                        true);
    }
