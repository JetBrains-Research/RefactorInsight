...
public class ReplaceLoopWithPipelineJavaHandler extends JavaRefactoringHandler {
    @Override
    public RefactoringInfo specify(Refactoring refactoring, RefactoringInfo info) {
        ReplaceLoopWithPipelineRefactoring ref = (ReplaceLoopWithPipelineRefactoring) refactoring;
