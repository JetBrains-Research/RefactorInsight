...
/**
 * Holds the data needed in order to create an {@link LineFragmentImpl}.
 * Retrieves information about refactorings' code ranges, corrects and modifies the data.
 */
public class RefactoringLine {
    ...
    public RefactoringLine(CodeRange left, CodeRange mid, CodeRange right,
                           VisualizationType type, MarkingOption option, boolean hasColumns) {
     ...
     */
    public RefactoringLine(CodeRange left, CodeRange mid, CodeRange right,
                           VisualizationType type, MarkingOption option,
